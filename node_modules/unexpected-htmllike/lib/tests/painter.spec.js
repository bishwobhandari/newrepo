...
describe('Painter', function () {
    ...
    it('outputs a single empty element', function () {
        ...
        expect(description, 'to output', '<div />');
    });
    ...
    it('outputs a single empty element with string attributes', function () {
        ...
        expect(description, 'to output', '<div id="abc" className="foo" />');
    });
    ...
    it('skips outputting attributes that are undefined', function () {
        ...
        expect(description, 'to output', '<div className="foo" />');
    });
    ...
    it('outputs a single empty element with object attributes', function () {
        ...
        expect(description, 'to output', '<div id="abc" style={{ width: 100, height: 200 }} />');
    });
    ...
    it('outputs many attributes over separate lines', function () {
        ...
        expect(description, 'to output', '<div id="abc" className="foo bah gah blah cheese" another="big long attribute value"\n' + '   style={{ width: 100, height: 200 }} role="button-with-a-long-name"\n' + '/>');
    });
    ...
    it('outputs a long function attribute without a body', function () {
        ...
        expect(description, 'to output', '<MyComponent onClick={function handleClick(a, b) { /* ... */ }} />');
    });
    ...
    it('outputs a short one line function attribute with a body', function () {
        ...
        expect(description, 'to output', '<MyComponent onClick={function shortFunc(a, b) { return a + b; }} />');
    });
    ...
    it('outputs a short multi line function attribute without a body', function () {
        ...
        expect(description, 'to output', '<MyComponent onClick={function shortMultiLine(a, b) { /* ... */ }} />');
    });
    ...
    it('outputs a long single line function attribute without a body', function () {
        ...
        expect(description, 'to output', '<MyComponent onClick={function longSingleLine(a, b) { /* ... */ }} />');
    });
    ...
    it('outputs an expect.it assertion as an assertion and not a function', function () {
        ...
        expect(description, 'to output', '<MyComponent onClick={expect.it(\'to be a function\')} />');
    });
    ...
    it('outputs a function with a custom toString() directly', function () {
        ...
        expect(description, 'to output', '<MyComponent onClick={function spy} />');
    });
    ...
    it('outputs a changed attribute', function () {
        ...
        expect(description, 'to output', '<div id="abc" // should be id="123"\n' + '              // -abc\n' + '              // +123\n' + '/>');
    });
    ...
    it('outputs a different attribute type', function () {
        ...
        expect(description, 'to output', '<div id="123" // should be id={123}\n' + '/>');
    });
    ...
    it('outputs a different attribute type and value', function () {
        ...
        expect(description, 'to output', '<div id="123" // should be id={1234}\n' + '/>');
    });
    ...
    it('outputs a different boolean attribute', function () {
        ...
        expect(description, 'to output', '<div disabled={true} // should be disabled={false}\n' + '/>');
    });
    ...
    it('outputs a changed attribute with an object diff', function () {
        ...
        expect(description, 'to output', "<div id={{ abc: 123, def: 'ghi' }} // should be id={{ abc: 123, def: 'ghij' }}\n" + '                                   // {\n' + '                                   //   abc: 123,\n' + "                                   //   def: 'ghi' // should equal 'ghij'\n" + '                                   //              //\n' + '                                   //              // -ghi\n' + '                                   //              // +ghij\n' + '                                   // }\n' + '/>');
    });
    ...
    it('outputs a missing attribute', function () {
        ...
        expect(description, 'to output', '<div // missing id="123"\n' + '/>');
    });
    ...
    it('outputs an extra attribte', function () {
        ...
        expect(description, 'to output', '<div id="abc" // id should be removed\n' + '/>');
    });
    ...
    it('outputs an inspected object attribute over multiple lines', function () {
        ...
        expect(description, 'to output', '<div // missing id={{\n' + "     //   test: 'one two three four five',\n" + "     //   foo: 'bar lah cheese',\n" + "     //   testing: 'is fun with long text',\n" + '     //   id: 42\n' + '     // }}\n' + '/>');
    });
    ...
    it('outputs a custom error when an attribute fails the `to satisfy`', function () {
        ...
        (0, _painter2['default'])(pen, description, expect.diff, expect.inspect);
    ...
    it('outputs many attributes over multiple lines', function () {
        ...
        expect(description, 'to output', '<div id="very-long-attribute-value" data-value1="very-long-attribute-value"\n' + '   data-value2="very-long-attribute-value">\n' + '  one\n' + '</div>');
    });
    ...
    it('outputs a single child element', function () {
        ...
        expect(description, 'to output', '<div><span /></div>');
    });
    ...
    it('outputs text content', function () {
        ...
        expect(description, 'to output', '<div>abc</div>');
    });
    ...
    it('outputs numeric content', function () {
        ...
        expect(description, 'to output', '<div>42</div>');
    });
    ...
    it('outputs an extra wrapper', function () {
        ...
        expect(description, 'to output', '<div> // wrapper should be removed\n' + '  <span>some text</span>\n' + '</div> // wrapper should be removed');
    });
    ...
    it('outputs a different named element without attributes or children', function () {
        ...
        expect(description, 'to output', '<div // should be <span\n' + '/>');
    });
    ...
    it('outputs a different named element with attributes in the middle of children', function () {
        ...
        expect(description, 'to output', '<body>\n' + '  <span>some text</span>\n' + '  <div // should be <span\n' + '     className="foo" id="abc123">\n' + '    <span>some text</span>\n' + '  </div>\n' + '  <span>some text</span>\n' + '</body>');
    });
    ...
    it('outputs a single line contentElementMismatch diff', function () {
        ...
        expect(description, 'to output', 'some content // should be <div className="foo">some text</div>');
    });
    ...
    it('outputs a single line elementContentMismatch diff', function () {
        ...
        expect(description, 'to output', '<div className="foo">some text</div> // should be \'some content\'');
    });
    ...
    describe('class differences', function () {
        ...
        it('outputs an extra className', function () {
            ...
            expect(description, 'to output', '<div className="one two three" // extra class \'two\'\n' + '/>');
        });
        ...
        it('outputs a missing className', function () {
            ...
            expect(description, 'to output', '<div className="one three" // missing class \'cheese\'\n' + '/>');
        });
        ...
        it('outputs multiple extra classes', function () {
            ...
            expect(description, 'to output', '<div className="one three two" // extra classes \'two three\'\n' + '/>');
        });
        ...
        it('outputs multiple missing classes', function () {
            ...
            expect(description, 'to output', '<div className="one three" // missing classes \'cheese another\'\n' + '/>');
        });
    });
